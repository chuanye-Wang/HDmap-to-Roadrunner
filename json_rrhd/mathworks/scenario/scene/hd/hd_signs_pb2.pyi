...
class SignTypeDefinition(_message.Message):
...
class Sign(_message.Message):
    __slots__ = ["id", "geometry", "sign_type_ref"]
    ID_FIELD_NUMBER: _ClassVar[int]
    GEOMETRY_FIELD_NUMBER: _ClassVar[int]
    SIGN_TYPE_REF_FIELD_NUMBER: _ClassVar[int]
    id: str
    geometry: _geometry_pb2.GeoOrientedBoundingBox
    sign_type_ref: _common_attributes_pb2.Reference
    def __init__(self, id: _Optional[str] = ..., geometry: _Optional[_Union[_geometry_pb2.GeoOrientedBoundingBox, _Mapping]] = ..., sign_type_ref: _Optional[_Union[_common_attributes_pb2.Reference, _Mapping]] = ...) -> None: ...
